...
def rename_trainings_columns(trainings: DataFrame) -> DataFrame:
    ...
    trainings = (
        ...
        .withColumnRenamed("content_type", "content_type")
        .withColumnRenamed("Description_s", "description")
        .withColumnRenamed("Duration_s", "duration")
        .withColumnRenamed("eosc_provider", "eosc_provider")
        .withColumnRenamed("format", "format")
        ...
        .withColumnRenamed("resource_type", "document_type")
