...
- `OUTPUT_PATH` - Where the output should be locally saved? Note that if the `CREATE_LOCAL_DUMP` variable will be set to `False`, output files will be deleted after each iteration.  Default: `output/`.
<br></br>
