...
from app.transform.mappings.datasources_pids import (datasource_pids_mapping,
                                                     services_pids)
from app.transform.mappings.scientific_doamin import (
    mp_sd_structure, scientific_domains_mapping)
from app.transform.schemas.mappings import (FIGSHARE, OPEN_ACCESS_, ZENODO,
                                            access_rights_mapping,
                                            language_mapping,
                                            publisher_mapping,
                                            unified_categories_mapping)
from app.transform.schemas.properties.data import (AFFILIATION, AUTHOR,
                                                   AUTHOR_NAMES,
                                                   AUTHOR_NAMES_TG,
                                                   AUTHOR_PIDS,
                                                   BEST_ACCESS_RIGHT, CONTEXT,
                                                   COUNTRY, DATA_SOURCE,
                                                   DOCUMENT_TYPE, DOI,
                                                   DOWNLOADS, EOSC_IF,
                                                   EOSC_IF_TG, EXPORTATION,
                                                   FOS, FUNDER, ID, INSTANCE,
                                                   KEYWORDS, KEYWORDS_TG,
                                                   LANGUAGE, NAME, OPEN_ACCESS,
                                                   PID, PIDS, POPULARITY,
                                                   PROJECTS, PUBLISHER,
                                                   RELATED_ORGANISATION_TITLES,
                                                   RELATED_PROJECT_IDS,
                                                   RELATIONS, RELATIONS_LONG,
                                                   RESEARCH_COMMUNITY,
                                                   SCIENTIFIC_DOMAINS, SDG,
                                                   SUBJECT, TAG_LIST,
                                                   TAG_LIST_TG, TYPE,
                                                   UNIFIED_CATEGORIES, URL,
                                                   VIEWS)
