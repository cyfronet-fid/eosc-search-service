...
import { InteroperabilityPageModule } from '@pages/interoperability-page/interoperability-page.module';
...
@NgModule({
  imports: [
    RouterModule.forRoot([
      ...
      {
        path: 'interoperability-guidelines',
        loadChildren: () => InteroperabilityPageModule,
      },
      {
