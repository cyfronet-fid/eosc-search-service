...
export const trainingsCollection: ICollectionSearchMetadata<ITraining> = {
  ...
  fieldToFilter: {
    'Resource type': 'Resource_Type_s',
    'Content type': 'Content_Type_s',
    'Language': 'Language_s',
    'License': 'License_s',
    'Organization': 'EOSC_PROVIDER_s',
    'Format': 'Format_ss',
    'Level of expertise': 'Level_of_expertise_s',
    'Target group': 'Target_group_s',
    'Qualification': 'Qualification_s',
    'Duration': 'Duration_s',
    'Created on': 'Version_date__created_in__s',
  },
  _hash: '',
